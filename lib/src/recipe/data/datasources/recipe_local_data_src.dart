  ...
  Future<void> cacheRecipes(List<RecipeModel> recipes) async {
    try {
      ...
      for (var recipe in recipes) {
        ...
        recipeMap['ingredients'] = json
            .encode(recipeMap['ingredients'].map((i) => i.toMap()).toList());
        recipeMap['instructions'] = json.encode(recipeMap['instructions']);
        recipeMap['mealTypes'] = json.encode(recipeMap['mealTypes']);
        recipeMap['ingredients'] = json
            .encode(recipeMap['ingredients'].map((i) => i.toMap()).toList());
